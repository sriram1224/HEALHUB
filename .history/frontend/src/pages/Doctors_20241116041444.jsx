        ...
        <div className="rounded-lg md:w-1/4">
          <div className="p-4 rounded-lg items-center border ">
            ...
            >
              ...
              {showFilters ? (
                <AiOutlineUp className="text-white ml-2 text-xl transition-transform duration-300 transform rotate-180" />
              ) : (
                <AiOutlineDown className="text-white ml-2 text-xl transition-transform duration-300 transform" />
              )}
            </button>
