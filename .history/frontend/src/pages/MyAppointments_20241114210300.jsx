...
const MyAppointments = () => {
  ...
  return (
    <div className="p-6 bg-gradient-to-br from-gray-800 to-gray-900 min-h-screen text-white">
          ...
          <div className="grid gap-6 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3">
            {appointments.map((appointment) => (
              <div
                ...
                className="p-6 bg-gray-800 rounded-lg shadow-lg transform transition duration-300 hover:scale-105"
              >
