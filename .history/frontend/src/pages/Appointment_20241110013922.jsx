  ...
  return (
    <div className="text-white p-6 bg-black min-h-screen">
      <div className="flex flex-col md:flex-row items-stretch gap-6">
        ...
        <div className="w-full md:w-[70%] bg-gray-900 p-4 rounded-lg shadow-lg border border-white flex flex-col">
          ...
          <button
            ...
            className="bg-blue-500 text-white px-5 py-2.5 rounded-lg hover:bg-blue-600 transition duration-300 mt-auto"
          >
            Book an Appointment
          </button>
        </div>
