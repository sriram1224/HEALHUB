...
const Appointment = () => {
  ...
  const getAvailableSlots = async () => {
    const slots = []; // Temp array to store all slots for 7 days
    ...
    for (let i = 0; i < 7; i++) {
      ...
      slots.push(...timeSlots); // Add day's slots to overall array
    }

    setDocSlot(slots); // Set docSlot only once after loop
  };
