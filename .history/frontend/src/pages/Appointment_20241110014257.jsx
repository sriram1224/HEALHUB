  ...
  return (
    <div className="text-white p-6 bg-black min-h-screen">
      <div className="flex flex-col md:flex-row items-stretch gap-6">
        ...
        <div className="w-full md:w-[90%] bg-gray-900 p-4 rounded-lg shadow-lg border border-white flex flex-col">
          ...
          <p className="text-gray-500 text-sm mb-3">{docInfo.about}</p>
          <p className="text-white text-sm mb-3">Fees: ${docInfo.fees}</p>
