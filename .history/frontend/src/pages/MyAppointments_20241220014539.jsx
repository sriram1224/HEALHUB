...
const MyAppointments = () => {
  ...
  const initPay = (order) => {
    const options = {
      key: import.meta.env.VITE_RAZORPAY_KEY_ID || "rzp_test_HVzUoMU4jcFJUK", // Replace with your key
      amount: order.amount,
      currency: order.currency,
      name: "Appointment Payment",
      description: "Payment for booking an appointment",
      order_id: order.id,
  ...
  const appointmentsRazorpay = async (appointmentId) => {
    try {
                ...
                <div className="flex flex-col gap-4">
                  {appointment.cancelled ? (
                    ...
                    <>
                      <button
                        onClick={() => {
                          appointmentsRazorpay(appointment._id);
                        }}
