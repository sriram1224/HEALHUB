  ...
  return (
    <div className="text-white p-6 bg-black">
      <div className="flex flex-col md:flex-row gap-10">
        {/* Left - filters */}
        <div className="rounded-lg md:w-1/4">
          <div className="p-4 rounded-lg items-center border ">
            <h1 className="cursor-pointer border w-full mb-3 p-3 text-xl text-center rounded-lg hidden md:block">
              Filter
            </h1>
            {/* Filter button only shows on mobile */}
            <button
              className="text-xl font-bold mb-4 w-2/8 md:hidden bg-gradient-to-r from-blue-500 to-blue-600 text-white py-2 px-6 rounded-lg flex items-center justify-between hover:from-blue-600 hover:to-blue-700 transition-all duration-300 shadow-lg transform hover:scale-105"
            ...
            >
              ...
              {showFilters ? (
                <AiOutlineUp className="text-white ml-2 text-lg transition-transform duration-300 transform rotate-180 inline-block" />
              ) : (
                <AiOutlineDown className="text-white ml-2 text-lg transition-transform duration-300 transform rotate-0 inline-block" />
              )}
            </button>
              ...
              <div className="md:block">
                <ul className="space-y-2">
                  <li
                    ...
                    className={`cursor-pointer p-3 rounded-lg text-center hover:bg-blue-500 transition duration-300 ${
                      speciality === "General physician"
                        ? "bg-blue-500"
                        : "bg-black border border-blue-800"
                    }`}
                  >
                    General physician
                  </li>
