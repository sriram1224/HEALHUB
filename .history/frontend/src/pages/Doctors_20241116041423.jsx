      ...
      <div className="flex flex-col md:flex-row gap-10">
        ...
        <div className="rounded-lg md:w-1/4">
          <div className="p-4 rounded-lg items-center border ">
            ...
            <button
              className="text-2xl  mb-4 w-2/8  md:hidden bg-gradient-to-r from-blue-500 to-blue-600 text-white py-2 px-6 rounded-lg flex items-center justify-between hover:from-blue-600 hover:to-blue-700 transition-all duration-300 shadow-lg transform hover:scale-105"
