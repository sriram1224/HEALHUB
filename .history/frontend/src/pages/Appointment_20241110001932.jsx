...
const Appointments = () => {
  ...
  return (
    <div className="text-white p-6 bg-black min-h-screen">
      <div className="max-w-screen-lg mx-auto flex flex-col md:flex-row items-stretch gap-6">
        {/* Left - Doctor's Photo */}
        <div className="w-full md:w-1/3 bg-blue-100 p-4 rounded-lg shadow-lg flex items-center justify-center">
          <img
            src={docInfo.image}
            alt={docInfo.name}
