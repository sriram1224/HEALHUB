    ...
    <div className="text-white p-6 bg-black">
      <div className="flex flex-col md:flex-row gap-10">
        ...
        <div className="rounded-lg md:w-1/4">
          <div className=" rounded-lg items-center border ">
            <h1 className="cursor-pointer border w-2/3 mb-5 p-3 text-xl text-center rounded-lg hidden md:block">
              Filter
            </h1>
              ...
              <div className="md:block">
                <ul className="space-y-2">
                  <li
                    ...
                    className={`cursor-pointer p-3 w-2/3 rounded-lg hover:bg-blue-500 transition duration-300 ${
                      speciality === "General physician"
                        ? "bg-blue-500"
                        : "bg-gray-700"
                    }`}
