              ...
              >
                ...
                <div className="flex flex-col gap-4">
                  {appointment.cancelled ? (
                    // Show disabled "Cancelled" button if appointment is cancelled
                    <button
                      className="px-6 py-2 text-lg font-semibold text-gray-400 bg-gray-700 rounded-lg shadow-md cursor-not-allowed"
                      disabled
                    >
                      Cancelled
                    </button>
                  ) : (
                    // Show "Pay Online" and "Cancel Appointment" buttons if not cancelled
                    <>
