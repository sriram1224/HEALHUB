    ...
    <div className="text-white p-6 bg-black">
      <div className="flex flex-col md:flex-row gap-10">
        ...
        <div className=" p-6 rounded-lg md:w-1/4">
          ...
          <button
            className="text-2xl font-bold mb-4 w-2/8 text-left md:hidden bg-blue-500 text-white py-2 px-4 rounded-lg flex items-center justify-between hover:bg-blue-600 transition duration-300"
          ...
          {filteredDoc.map((item, index) => (
            ...
            >
              <img
                src={item.image}
                alt={item.name}
                className="w-32 rounded-full h-32 md:w-40 md:h-40 lg:w-48 lg:h-48 rounded-full shadow-md border-2 bg-blue-700 object-cover mb-4"
              />
