    ...
    <div className="text-white p-6 bg-black">
      <div className="flex flex-col md:flex-row gap-10">
        ...
        <div className=" p-6 rounded-lg md:w-1/4">
          ...
          <button
            className="text-2xl font-bold mb-4 w-3/4 text-left md:hidden bg-blue-500 text-white py-2 px-4 rounded-lg flex items-center justify-between hover:bg-blue-600 transition duration-300"
