    ...
    <div className="text-white p-6 bg-black">
      <div className="flex flex-col md:flex-row gap-10">
        ...
        <div className=" p-6 rounded-lg md:w-1/4">
          ...
          <button
            className="text-2xl font-bold mb-4 w-1/3  text-left md:hidden bg-gradient-to-r from-blue-500 to-blue-600 text-white py-2 px-6 rounded-lg flex items-center justify-between hover:from-blue-600 hover:to-blue-700 transition-all duration-300 shadow-lg transform hover:scale-105"
