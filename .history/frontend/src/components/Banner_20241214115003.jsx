...
const Banner = () => {
  ...
  return (
    <div className="bg-gradient-to-r ml-20 mr-20 from-blue-800 to-black mt-10 mb-10 px-6 md:px-20 rounded-lg flex flex-col md:flex-row items-center text-white relative">
      {/* left */}
      ...
      <div className="flex-1 mt-6 md:mt-0 relative flex justify-center md:justify-end">
        <img
          ...
          alt="Appointment"
          className="w-40 h-auto md:w-60 md:h-auto display-none   mt:10 md:-mt-10"
        />
      </div>
    </div>
  );
