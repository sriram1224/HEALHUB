...
const Navbar = () => {
  ...
  return (
    <nav className="bg-black  bg-gradient-to-r from-blue-400 to-green-400">
      <div className="max-w-screen-xl border-b-2 border-green-500 flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="/" className="flex items-center space-x-3 rtl:space-x-reverse">
          {
            //<img src={logo} alt="Logo" className="h-15 w-12" />
          }

          <span className="self-center text-2xl font-semibold whitespace-nowrap text-green-500 russo-one-regular">
            H E A L H U B
          </span>
        </a>
        ...
        <div
          ...
          id="navbar-cta"
        >
          <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border text-blue-800 rounded-lg bg-black md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-black">
            <li>
              <NavLink
                to="/"
                className={({ isActive }) =>
