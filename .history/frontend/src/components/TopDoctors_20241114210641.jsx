      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
        {doctors.slice(0, 10).map((item, index) => (
          <div
            ...
            key={index}
            className="bg-gray-800 p-6 rounded-lg shadow-md hover:shadow-lg hover:bg-black border-blue-400 transition-transform duration-300 transform hover:-translate-y-2"
          >
            <img
              src={item.image}
              alt={item.name}
