...
const Navbar = () => {
  ...
  return (
    <nav className="bg-white  border-gray-200">
      <div className="max-w-screen-xl C border-blue-300 flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
          <button
            ...
            className="bg-blue-800 text-white px-4 py-2 rounded hover:bg-white hover:text-black border-blue-700 transition duration-300"
          >
            Create an account
          </button>
          <button
