          ...
          <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white">
            <li>
              <NavLink
                ...
                className={({ isActive }) =>
                  isActive
                    ? "block py-2 px-3 md:p-0 text-black hover:text-blue-700 border-b-2 border-blue-700"
                    : "block py-2 px-3 md:p-0 text-black hover:border-b-2 hover:text-blue-700"
                }
              >
                HOME
              </NavLink>
            ...
            <li>
              <NavLink
                ...
                className={({ isActive }) =>
                  isActive
                    ? "block py-2 px-3 md:p-0 text-black border-b-2 border-blue-700 hover:text-blue-700"
                    : "block py-2 px-3 md:p-0 text-black hover:border-b-2 hover:text-blue-400 hover:border-blue-700"
                }
              >
                CONTACT
              </NavLink>
