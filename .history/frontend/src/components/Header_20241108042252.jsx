...
const Header = () => {
  return (
    <div className="max-w-screen-xl mx-auto flex flex-col md:flex-row items-center bg-gradient-to-r from-blue-800 to-black rounded-lg  pb-0 p-6 text-white mt-3">
