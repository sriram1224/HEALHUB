...
const Banner = () => {
  ...
  return (
    <div className="bg-gradient-to-r ml-10 mr-20 from-blue-800 to-black mt-10 mb-10 px-6 md:px-20 rounded-lg flex flex-col md:flex-row items-center text-white relative">
      {/* left */}
