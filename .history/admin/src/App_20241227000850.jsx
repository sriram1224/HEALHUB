      ...
      <div
        ...
        style={{
          background: isDarkMode
            ? "linear-gradient(to right, #3D52A0, #7091E6, #8697C4, #ADBBDA, #EDE8F5)" // Gradient for Dark Mode
            : "linear-gradient(to right, #3D52A0, #7091E6, #8697C4, #ADBBDA, #EDE8F5)", // Gradient for Light Mode (same colors for consistency)
        }}
      >
