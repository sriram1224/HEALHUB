...
const Sidebar = () => {
  ...
  return (
    <aside className="h-full p-4 w-20 md:w-60 bg-gray-100 dark:bg-black text-black dark:text-white transition-all border-r border-gray-300 dark:border-gray-700 flex flex-col">
      {atoken && (
