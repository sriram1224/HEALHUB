      ...
      >
        ...
        <div className="mb-8">
          ...
          <input
            ...
            value={email}
            required
            className="w-full p-4 text-sm text-white bg-gray-800 border border-gray-500 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent placeholder-gray-400"
          />
        </div>
        <div className="mb-8">
          <label className="block text-base font-medium text-blue-300 mb-3">
