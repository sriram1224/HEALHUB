    ...
    dashData && (
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          {/* Doctors */}
          <div className="flex flex-col items-center p-4 bg-gray-800 text-white border-2 border-blue-500 rounded-lg shadow hover:shadow-lg transition duration-300">
            <img
        ...
        <div
          ...
          } p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300 border-2 border-blue-500`}
        >
          ...
          <div className="space-y-4">
            {(dashData.latestAppointments?.length > 0
              ...
              <div
                ...
                } rounded-md hover:bg-gray-700 transition duration-200`}
              >
                {/* Doctor Info */}
