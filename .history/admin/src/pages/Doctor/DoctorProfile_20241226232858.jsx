...
const DoctorProfile = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-gray-700 shadow-lg rounded-xl border-4 border-yellow-600">
      ...
      <div className="text-center mb-4">
        <p className="text-3xl font-semibold text-white">{profileData.name}</p>
      ...
      {/* Doctor's About */}
      <div className="mb-6">
        <p className="text-lg text-gray-300">{profileData.about}</p>
      ...
      <div className="flex items-center mb-6">
        ...
        />
        <label className="text-lg text-white">Available</label>
      </div>
    </div>
  );
};
