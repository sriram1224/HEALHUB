                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-center font-semibold">
                      {item.isCompleted ? (
                        <div className="text-green-500 border border-green-500 px-2 py-1">
                          Completed
                        </div>
                      ) : item.cancelled ? (
                        <p className="text-red-500 border border-red-500 px-2 py-1 font-normal">
                          Cancelled
                        </p>
                      ) : (
                        <div className="flex items-center justify-center gap-2">
                          ...
                          <button
                            ...
                            className="px-2 py-1 border-red-500 border text-red-500 "
                          >
                            Cancel
                          </button>
                        </div>
