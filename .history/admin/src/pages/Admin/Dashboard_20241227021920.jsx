    ...
    dashData && (
      <div className="p-4  min-h-screen">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          {/* Doctors */}
          <div className="flex flex-col items-center p-4  text-white rounded-lg shadow hover:shadow-lg transition duration-300">
            <img
          ...
          {/* Patients */}
          <div className="flex flex-col items-center p-4 border bprder-blue-400 text-white rounded-lg shadow hover:shadow-lg transition duration-300">
            <img
        ...
        {/* Latest Appointments */}
        <div className=" text-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
