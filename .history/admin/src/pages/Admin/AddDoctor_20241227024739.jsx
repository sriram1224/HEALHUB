    ...
    <div className="min-h-screen flex items-center text-[#6523a7]  justify-center px-4">
      ...
      >
        ...
        <div className="mb-6 flex justify-center">
          <label
            htmlFor="doc-img"
            className="block border-2 border-dashed  rounded-lg p-6 text-[#6523a7] cursor-pointer border-yellow-500 transition duration-200"
          >
            <img
            ...
            />
            <p className="text-[#6523a7] font-bold">Upload Doctor's Picture</p>
          </label>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div className="space-y-6">
            ...
            <div>
              <label className="font-bold 0 mb-2">Doctor Email</label>
              <input
                type="email"
                value={email}
            ...
            <div>
              <label className="font-bold  mb-2">Doctor Password</label>
              <input
                type="password"
            ...
            <div>
              <label className="font-bold  mb-2">Fees</label>
              <input
                type="number"
          ...
          <div className="space-y-6">
            <div>
              <label className="font-bold mb-2">Specialty</label>
              <select
                value={speciality}
