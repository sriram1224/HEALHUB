                  ...
                  >
                    ...
                    <td className="px-4 py-10 flex items-center gap-3">
                      <img
                        ...
                        alt="Patient"
                        className="w-12 h-12 rounded-full object-cover border border-orange-800"
                      />
                    ...
                    <td className="px-4 py-3 flex items-center gap-3">
                      <img
                        src={docData.image}
                        alt="Doctor"
                        className="w-10 h-10 rounded-full object-cover bg-gradient-to-r from-yellow-300 to-orange-400 border border-yellow-300"
                      />
