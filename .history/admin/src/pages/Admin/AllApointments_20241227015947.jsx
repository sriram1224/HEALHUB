                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-center font-semibold">
                      {item.isCompleted ? (
                        <div className="text-green-500 border border-green-500 px-2 py-1 rounded-full">
                          Completed
                        </div>
                      ) : item.cancelled ? (
                        <p className="text-red-500 border border-red-500 px-2 py-1 font-normal rounded-full">
                          Cancelled
                        </p>
                      ) : (
