...
const AllAppointments = () => {
  ...
  return (
    <div className="p-6  min-h-screen  text-[#6523a7]">
      <h2 className="text-3xl font-extrabold mb-6 text-center">
        All Appointments
      </h2>
      <div className="overflow-x-auto rounded-lg border border-[#d7d6d9] shadow-lg">
                ...
                return (
                  ...
                  >
                    ...
                    <td className=" py-3 text-center font-bold">
                      {item.isCompleted ? (
                        <div className="text-green-500 border   py-1 rounded">
                          Appointment Completed
                        </div>
                      ) : item.cancelled ? (
                        <p className="text-red-500 border    font-normal w-54">
