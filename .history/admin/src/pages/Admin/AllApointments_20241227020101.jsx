                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-center font-semibold">
                      {item.isCompleted ? (
                        <div className="text-green-500 border border-green-500 px-2 py-1 rounded">
                          Completed
                        </div>
                      ) : item.cancelled ? (
                        <p className="text-red-500 border border-red-500 px-2 py-1 font-normal rounded">
                          Cancelled
                        </p>
                      ) : (
                        <div className="flex items-center justify-center gap-2 px-1 py-1 border border-gray-500 rounded-lg">
                          <span>
                            {currency}
                            {docData.fees}
                          </span>
