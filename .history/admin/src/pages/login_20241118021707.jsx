...
const Login = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-800">
      <form className="w-full max-w-lg bg-gradient-to-br from-gray-800  to-black border border-gray-400 p-10 rounded-xl ">
        <div className="mb-8">
        ...
        <button
          type="submit"
          className="w-full py-4 mt-4 text-lg font-bold text-white bg-blue-200 rounded-lg hover:bg-blue-600 focus:ring-4 focus:ring-blue-400 focus:outline-none transition-all"
        >
          Login
        </button>
      </form>
