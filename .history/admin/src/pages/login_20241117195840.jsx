  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-black to-gray-900">
      <form className="bg-gradient-to-br from-gray-800 to-gray-900 border border-blue-600 p-8 rounded-xl shadow-2xl transform hover:scale-105 transition duration-300">
        <div className="mb-6">
          <p className="text-3xl font-extrabold text-center text-blue-400 tracking-wider">
            {state} Login
          </p>
        </div>
        <div className="mb-6">
          ...
          <input
            ...
            className="w-full p-3 text-sm text-white bg-gray-800 border border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent placeholder-gray-500"
          />
        </div>
        <div className="mb-6">
          <label className="block text-sm font-medium text-blue-300 mb-2">
